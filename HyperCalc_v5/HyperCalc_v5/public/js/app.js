...
// Load all 30 modules dynamically
const modules = [
  'architecture','civil','physics','geometry','math',
  'astronomy','space','engineering','mechanics','electrics',
  'robotics','ai','environment','chemistry','biology',
  'geography','cartography','design','interior','landscape',
  'structural','fluid','thermal','materials','quantum',
  'finance','statistics','optimization','simulation','experimental'
];
