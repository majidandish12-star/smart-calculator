...
document.getElementById('suggestDesign').onclick=()=>{
  // پیشنهاد طراحی مدرن، کلاسیک، آسیایی، جنگلی، هتل و آپارتمان
  const designs=[
    {type:'Modern',color:0xff0000},
    {type:'Classic',color:0x00ff00},
    {type:'Asian',color:0x0000ff},
    {type:'Forest',color:0x00ffff},
    {type:'Hotel',color:0xff00ff},
    {type:'Apartment',color:0xffff00}
  ];
  designs.forEach(d=>{
